...
fun ContextThemeWrapper.setResources(resources: Resources) {

    val resourcesField = ContextThemeWrapper::class.java.getDeclaredField("mResources")
    resourcesField.isAccessible = true
    resourcesField.set(this, resources)
